        ...
        <div className={s.aboutSection}>
          <div className={s.aboutContent}>
            ...
            <ul className={s.aboutFeatures}>
              <li className={s.featureItem}>Бесплатная диагностика</li>
              <li className={s.featureItem}>Гарантия до 3 лет</li>
              <li className={s.featureItem}>Оригинальные запчасти</li>
              <li className={s.featureItem}>Выезд мастера на дом</li>
            </ul>
          </div>
